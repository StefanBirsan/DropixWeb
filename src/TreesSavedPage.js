    ...
    return (
        <div className="second-page">
            ...
            <div className="content-container" style={{ marginTop: "100px", textAlign: "center" }}>
                <h2>Trees Saved</h2>
                <p>
                    Welcome to the Trees Saved page. Here you can see our initiatives in action and how many trees have been saved.
                    This is placeholder text—feel free to modify it.
                </p>
